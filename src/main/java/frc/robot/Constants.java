...
public final class Constants {
  ...
  public static class RioBusCANIds {
    ...
    public static int SHOOTER_MOTOR_TWO_ID = 14;
    public static int SHOOTER_MOTOR_THREE_ID = 15;
    public static int KICKER_MOTOR_ID = 3; // TODO update ID
    public static int HOOD_MOTOR_ID = -1; // TODO update ID
