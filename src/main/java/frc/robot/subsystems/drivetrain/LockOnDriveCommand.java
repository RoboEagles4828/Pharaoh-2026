...
public class LockOnDriveCommand extends Command {
	...
	public LockOnDriveCommand(
		...
		// Depending on where we are on the field when we start this command, choose a lock on point
	...
	public void execute() {
		...
		Translation2d toHub = targetPosition.minus(robotPose.getTranslation());
