...
public class TunerConstants {
    ...
    private static final Slot0Configs frontLeftDriveGains = new Slot0Configs()
        .withKP(0.0053391).withKI(0).withKD(0)
        .withKS(0.26174).withKV(0.11937);
    private static final Slot0Configs backLeftDriveGains = new Slot0Configs()
        .withKP(0.00021895).withKI(0).withKD(0)
        .withKS(0.2243).withKV(0.11921);
    private static final Slot0Configs backRightDriveGains = new Slot0Configs()
        .withKP(0.0066489).withKI(0).withKD(0)
        .withKS(0.26119).withKV(0.12031);
    private static final Slot0Configs frontRightDriveGains = new Slot0Configs()
        .withKP(0.042889).withKI(0).withKD(0)
        .withKS(0.23876).withKV(0.12641);
    ...
    public static final CANBus kCANBus = new CANBus(Constants.CANIVORE_NAME, "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.41162109375);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.466064453125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.3837890625);
    ...
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontLeft =
        ConstantCreator.withDriveMotorGains(frontLeftDriveGains).createModuleConstants(
            kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset,
            kFrontLeftXPos, kFrontLeftYPos, kInvertLeftSide, kFrontLeftSteerMotorInverted, kFrontLeftEncoderInverted
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FrontRight =
        ConstantCreator.withDriveMotorGains(frontRightDriveGains).createModuleConstants(
            kFrontRightSteerMotorId, kFrontRightDriveMotorId, kFrontRightEncoderId, kFrontRightEncoderOffset,
            kFrontRightXPos, kFrontRightYPos, kInvertRightSide, kFrontRightSteerMotorInverted, kFrontRightEncoderInverted
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackLeft =
        ConstantCreator.withDriveMotorGains(backLeftDriveGains).createModuleConstants(
            kBackLeftSteerMotorId, kBackLeftDriveMotorId, kBackLeftEncoderId, kBackLeftEncoderOffset,
            kBackLeftXPos, kBackLeftYPos, kInvertLeftSide, kBackLeftSteerMotorInverted, kBackLeftEncoderInverted
        );
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BackRight =
        ConstantCreator.withDriveMotorGains(backRightDriveGains).createModuleConstants(
