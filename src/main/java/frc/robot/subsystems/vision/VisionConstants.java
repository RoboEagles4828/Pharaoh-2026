...
public class VisionConstants {
    ...
    final static double POSE_AMBIGUITY_THRESHOLD = 0.5; // < Reject the pose if ambiguity is above this.
    final static double POSE_DISTANCE_THRESHOLD = 10.0; // < Reject the pose if distance is above this (meters).
    ...
    final static double VISION_TRUST_SCALAR = 0.5;
